...
type mockConstructorTestingTNewSESAPI interface {
	mock.TestingT
	Cleanup(func())
}

// NewSESAPI creates a new instance of SESAPI. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSESAPI(t mockConstructorTestingTNewSESAPI) *SESAPI {
	mock := &SESAPI{}
	mock.Mock.Test(t)
